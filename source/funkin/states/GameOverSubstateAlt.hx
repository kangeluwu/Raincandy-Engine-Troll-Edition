...
class GameOverSubstateAlt extends MusicBeatSubstate
{
	public static var instance:GameOverSubstateAlt;
	...
	override function create()
	{
		...
		FlxG.timeScale = 1.0;
		var sprite = CoolUtil.blankSprite(FlxG.width, FlxG.height,0x82070707);
		FlxTween.tween(sprite,{alpha:1},4);
		add(sprite);
		...
		FlxG.sound.playMusic(_musicAsset, 0);
		if (FlxG.sound.music != null)
			FlxG.sound.music.fadeIn(0, 1, 10);
	}
